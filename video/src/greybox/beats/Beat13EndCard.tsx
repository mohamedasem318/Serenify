 ...
 *   2. "take care of yourself" types on   f38–70
 *   3. "serenify.tech" types on   f78–102
 *
 ...
 * second, which is a deliberate pace at best and a stall at worst. They now run 1.0s,
 * ~20 c/s and ~16 c/s. The hold after "serenify.tech" is unchanged at 34 frames
 * (~1.13s) — including the second added in revision 4 — because that is where the VO
 * lands its last line and it is room in the cut rather than dead air.
 *
 * The beat is therefore 180 → 136 frames, all of it out of the typing.
 */
