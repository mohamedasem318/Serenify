...
See Remotion Maps (skill not installed in this repo — see video/README.md) if wanting to include maps in the video.
...
For static maps, animated routes and markers, geographic explainers, Mapbox, MapLibre, MapTiler, GeoJSON, or 3D geographic flyovers, load Remotion Maps (skill not installed in this repo — see video/README.md).
