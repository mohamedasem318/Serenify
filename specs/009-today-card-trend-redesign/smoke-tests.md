...
**Sign-off**: Mohamed Asem  **Date**: ________  **Overall**: ☐ PASS ☐ FAIL
...
**Pass when**: all four hold. Result: ____________________
...
**Pass when**: scrolls at intrinsic width, no stretch, no crush, edge-fades present. Result: ____________________
...
**Pass when**: no wide flash, no vertical shift on load. Result: ____________________
...
**Pass when**: plot targets focusable with a ring, rows not tab stops, highlight syncs both ways. Result: ____________________
...
**Pass when**: every animation is skipped and function survives. Result: ____________________
...
**Pass when**: every honesty rule holds and the headline matches the day. Result: ____________________
...
|----|-------|--------|------|
| ST-1 | Light-mode amber tokens (chip #8A580F / head #BC7A2A 700 / graphic-only) | | keyword on card surface, not page bg |
| ST-2 | 360px intrinsic-width scroll, lanes → 112 | | real-browser no-stretch eyeball |
| ST-3 | No first-paint width flash (T031) | | throttled reload + JS-disabled cross-check |
| ST-4 | Keyboard targets + focus ring; rows not tab stops | | synced highlight both ways |
| ST-5 | Reduced motion honoured | | live toggle |
| ST-6 | Honesty on a real day (warm-up/lost-read/no-read/peak/headline) | | |
