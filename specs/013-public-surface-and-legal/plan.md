...
| **P3 — Legal + public shell** | `app/(public)/` group with `layout.tsx`, `terms/`, `privacy/`; `components/legal/`; `lib/legal/copy.ts`; public navbar + footer (**"© 2026 Serenify"**, §10.3) + mobile nav; the copy-invariant tests; **the §0.3 `README.md` fix — one added sentence for lines 15/16/18, a sentence *split* for line 11**. **`/` is untouched.** | P1 |
