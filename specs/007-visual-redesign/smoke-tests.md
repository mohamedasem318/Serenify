...
**Sign-off**: _____________________  **Date**: __________  **Overall**: ☐ PASS ☐ FAIL
...
| 4 | **Amber** soft-tint notice text | the amber stress-signal notice (tint bg + same-family text) | ☐ | ☐ |
...
**Pass when**: all 16 cells clear AA. Result: ____________________________________________
...
**Pass when**: zero matches and no visible glassmorphism. Result: __________________________
...
**Pass when**: all five hold. Result: ____________________________________________
...
**Pass when**: every animation is skipped/reduced and function is preserved. Result: ____________
...
**Pass when**: both match the mocks by eye in both modes. Result: ____________________________
...
**Pass when**: all three hold. Result: ____________________________________________
...
**Pass when**: no amber/red error treatment and no solid-amber-with-ink fill remain. Result: ______
...
**Pass when**: the dark-mode scrim provides clear modal separation. Result: ________________
...
**Pass when**: no reflow/clipping from the size bump anywhere. Result: ____________________
...
|----|-------|--------|------|
| ST-1 | WCAG AA both modes | ☐ | |
| ST-2 | Preserved states / 3 roles | ☐ | |
| ST-3 | Zero glassmorphism | ☐ | |
| ST-4 | 360px + touch targets | ☐ | |
| ST-5 | Reduced motion | ☐ | |
| ST-6 | Mock fidelity (OTP + orb) | ☐ | |
| ST-7 | Wordmark + typeface | ☐ | |
